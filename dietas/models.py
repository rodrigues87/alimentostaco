...
class Dieta(models.Model):
    ...
    total_alanine_g = models.IntegerField(blank=True, null=True)
    total_arginine_g = models.IntegerField(blank=True, null=True)
    total_ashes_g = models.IntegerField(blank=True, null=True)
    total_aspartic_g = models.IntegerField(blank=True, null=True)
    total_calcium_mg = models.IntegerField(blank=True, null=True)
    total_carbohydrate_g = models.IntegerField(blank=True, null=True)
    total_cholesterol_mg = models.IntegerField(blank=True, null=True)
    total_copper_mg = models.IntegerField(blank=True, null=True)
    total_cystine_g = models.IntegerField(blank=True, null=True)
    total_energy_kcal = models.IntegerField(blank=True, null=True)
    total_energy_kj = models.IntegerField(blank=True, null=True)
    total_fiber_g = models.IntegerField(blank=True, null=True)
    total_glutamic_g = models.IntegerField(blank=True, null=True)
    total_glycine_g = models.IntegerField(blank=True, null=True)
    total_histidine_g = models.IntegerField(blank=True, null=True)
    total_humidity_percents = models.IntegerField(blank=True, null=True)
    total_iron_mg = models.IntegerField(blank=True, null=True)
    total_isoleucine_g = models.IntegerField(blank=True, null=True)
    total_leucine_g = models.IntegerField(blank=True, null=True)
    total_lipidius_g = models.IntegerField(blank=True, null=True)
    total_lysine_g = models.IntegerField(blank=True, null=True)
    total_magnesium_mg = models.IntegerField(blank=True, null=True)
    total_manganes_mg = models.IntegerField(blank=True, null=True)
    total_methionine_g = models.IntegerField(blank=True, null=True)
    total_monounsaturated_g = models.IntegerField(blank=True, null=True)
    total_niacin_mg = models.IntegerField(blank=True, null=True)
    total_phenylalanine_g = models.IntegerField(blank=True, null=True)
    total_phosphorus_mg = models.IntegerField(blank=True, null=True)
    total_polyunsaturated_g = models.IntegerField(blank=True, null=True)
    total_potassium_mg = models.IntegerField(blank=True, null=True)
    total_proline_g = models.IntegerField(blank=True, null=True)
    total_protein_g = models.IntegerField(blank=True, null=True)
    total_pyridoxine_mg = models.IntegerField(blank=True, null=True)
    total_rae_mcg = models.IntegerField(blank=True, null=True)
    total_re_mcg = models.IntegerField(blank=True, null=True)
    total_retinol_mcg = models.IntegerField(blank=True, null=True)
    total_riboflavin_mg = models.IntegerField(blank=True, null=True)
    total_saturated_g = models.IntegerField(blank=True, null=True)
    total_serine_g = models.IntegerField(blank=True, null=True)
    total_sodium_mg = models.IntegerField(blank=True, null=True)
    total_threonine_g = models.IntegerField(blank=True, null=True)
    total_tiamina_mg = models.IntegerField(blank=True, null=True)
    total_tryptophan_g = models.IntegerField(blank=True, null=True)
    total_tyrosine_g = models.IntegerField(blank=True, null=True)
    total_valine_g = models.IntegerField(blank=True, null=True)
    total_vitaminc_mg = models.IntegerField(blank=True, null=True)
    total_zinc_mg = models.IntegerField(blank=True, null=True)
...
def alimento_changed(sender, **kwargs):
    ...
    for alimento in alimentos:
        ...
        instance.total_energy_kcal = int(instance.total_energy_kcal + alimento.energy_kcal)
